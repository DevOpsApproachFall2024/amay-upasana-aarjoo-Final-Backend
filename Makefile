# This Makefile is for the TriviaApp extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[TriviaApp]
#     PREREQ_PM => { Crypt::PBKDF2=>q[0], Dancer2=>q[0], Dancer2::Plugin::JWT=>q[0], JSON=>q[0], JSON::MaybeXS=>q[0], MongoDB=>q[0] }
#     TEST_REQUIRES => {  }
...
TO_INST_PM = lib/TriviaApp/Quiz.pm \
	lib/TriviaApp/Users.pm \
	lib/TriviaApp/Utils.pm \
	setup.pl
...
TriviaApp.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"TriviaApp\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name: TriviaApp" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Crypt::PBKDF2: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  Dancer2: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  Dancer2::Plugin::JWT: '0'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"TriviaApp\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Crypt::PBKDF2\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Dancer2\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Dancer2::Plugin::JWT\" : \"0\"," >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"TriviaApp\" VERSION=\"\">" > TriviaApp.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT></ABSTRACT>" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR></AUTHOR>" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Crypt::PBKDF2\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Dancer2::\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Dancer2::Plugin::JWT\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"JSON::\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"JSON::MaybeXS\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"MongoDB::\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.40\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> TriviaApp.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> TriviaApp.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/TriviaApp/Quiz.pm blib\lib\TriviaApp\Quiz.pm \
	  lib/TriviaApp/Users.pm blib\lib\TriviaApp\Users.pm \
	  lib/TriviaApp/Utils.pm blib\lib\TriviaApp\Utils.pm \
	  setup.pl $(INST_LIB)\setup.pl 
